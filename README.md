...
I have to create a React App that will serve: 
  ...
  1. Client side pages
  2. some static pages on the fly, 
  3. and some server rendered pages 
    
under a single host name. 

What comes up in my mind to comind a node and react app in single src.

What I struglle with:

   1. what should be the structure of code base
   2. how to handle two packages.json ( for react and node 🥺 as I'm the new 🐝 )
